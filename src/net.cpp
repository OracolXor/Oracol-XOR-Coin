...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Oracol " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ec2-52-60-191-75.ca-central-1.compute.amazonaws.com", "52.60.191.75"},
    ...
    //{"ec2-35-183-5-10.ca-central-1.compute.amazonaws.com", "35.183.5.10"},
    //{"ec2-35-182-189-172.ca-central-1.compute.amazonaws.com", "35.182.189.172"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Oracol is probably already running."), addrBind.ToString().c_str());
        else
