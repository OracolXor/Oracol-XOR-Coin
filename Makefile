#############################################################################
# Makefile for building: oracol-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu May 25 08:56:22 2017
# Project:  oracol-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile oracol-qt.pro
#############################################################################
...
Makefile: oracol-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile oracol-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/oracol/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/oracol/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/oracol/src/leveldb/libleveldb.a: FORCE
	cd C:/oracol/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/oracol/src/leveldb/libleveldb.a && ranlib C:/oracol/src/leveldb/libmemenv.a
